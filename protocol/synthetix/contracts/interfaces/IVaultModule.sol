...
interface IVaultModule {
     ...
     * @param amount The new amount of the position.
     * @param leverage The new leverage value of the position.
     ...
     * @param amount The new amount of collateral delegated in the position.
     ...
     * @returns The collateralization ratio of the position (collateral / debt).
     */
     ...
     * @param poolId The id of the pool in which the account's position is held.
     * @param collateralType The address of the collateral used in the queried position.
     * @returns The amount of USD debt held by the position.
     */
     ...
     * @param poolId The id of the pool in which the account's position is held.
     * @param collateralType The address of the collateral used in the queried position.
     * @returns The amount of collateral used in the position.
     */
     ...
     * @param poolId The id of the pool in which the account's position is held.
     * @param collateralType The address of the collateral used in the queried position.
     * @returns collateralAmount The amount of collateral used in the position.
     * @returns collateralValue The value of the collateral used in the position.
     * @returns debt The amount of USD debt held in the position.
     * @returns collateralizationRatio The collateralization ratio of the position (collateral / debt).
     **/
     ...
     * @returns The overall debt of the vault.
     **/
     ...
     * @param collateralType The address of the collateral of the associated vault.
     * @returns The collateral of the vault.
     */
     ...
     * @param collateralType The address of the collateral of the associated vault.
     * @returns The collateralization ratio of the vault.
     */
