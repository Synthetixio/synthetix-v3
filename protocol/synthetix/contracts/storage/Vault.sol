...
library Vault {
    ...
    ) internal returns (uint256 usdWeightD18, uint256 usdCapacityD18, int256 deltaCapacityD18, int256 totalDebtD18, int256 deltaDebtD18) {
        VaultEpoch.Data storage epochData = currentEpoch(self);

        usdWeightD18 = (epochData.collateralAmounts.totalAmount() + epochData.totalExitingCollateralD18).mulDecimal(collateralPriceD18);
