...
export class Pool extends Entity {
  ...
  get configurations(): MarketConfigurationLoader {
    return new MarketConfigurationLoader(
      "Pool",
      this.get("id")!.toString(),
      "configurations",
    );
...
export class MarketSnapshotByDay extends Entity {
  ...
  static loadInBlock(id: string): MarketSnapshotByDay | null {
    return changetype<MarketSnapshotByDay | null>(
      store.get_in_block("MarketSnapshotByDay", id),
    );
  }

  static load(id: string): MarketSnapshotByDay | null {
    return changetype<MarketSnapshotByDay | null>(
      store.get("MarketSnapshotByDay", id),
    );
  }
...
export class MarketSnapshotByWeek extends Entity {
  ...
  static loadInBlock(id: string): MarketSnapshotByWeek | null {
    return changetype<MarketSnapshotByWeek | null>(
      store.get_in_block("MarketSnapshotByWeek", id),
    );
  }

  static load(id: string): MarketSnapshotByWeek | null {
    return changetype<MarketSnapshotByWeek | null>(
      store.get("MarketSnapshotByWeek", id),
    );
  }
...
export class MarketConfiguration extends Entity {
  ...
  static loadInBlock(id: string): MarketConfiguration | null {
    return changetype<MarketConfiguration | null>(
      store.get_in_block("MarketConfiguration", id),
    );
  }
...
export class CollateralType extends Entity {
  ...
  static loadInBlock(id: string): CollateralType | null {
    return changetype<CollateralType | null>(
      store.get_in_block("CollateralType", id),
    );
  }
...
export class VaultSnapshotByDay extends Entity {
  ...
  static loadInBlock(id: string): VaultSnapshotByDay | null {
    return changetype<VaultSnapshotByDay | null>(
      store.get_in_block("VaultSnapshotByDay", id),
    );
  }

  static load(id: string): VaultSnapshotByDay | null {
    return changetype<VaultSnapshotByDay | null>(
      store.get("VaultSnapshotByDay", id),
    );
  }
...
export class VaultSnapshotByWeek extends Entity {
  ...
  static loadInBlock(id: string): VaultSnapshotByWeek | null {
    return changetype<VaultSnapshotByWeek | null>(
      store.get_in_block("VaultSnapshotByWeek", id),
    );
  }

  static load(id: string): VaultSnapshotByWeek | null {
    return changetype<VaultSnapshotByWeek | null>(
      store.get("VaultSnapshotByWeek", id),
    );
  }
...
export class VaultSnapshotByMonth extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save VaultSnapshotByMonth entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type VaultSnapshotByMonth must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("VaultSnapshotByMonth", id.toString(), this);
    }
  }

  static loadInBlock(id: string): VaultSnapshotByMonth | null {
    return changetype<VaultSnapshotByMonth | null>(
      store.get_in_block("VaultSnapshotByMonth", id),
    );
  }

  static load(id: string): VaultSnapshotByMonth | null {
    return changetype<VaultSnapshotByMonth | null>(
      store.get("VaultSnapshotByMonth", id),
    );
  }
...
export class VaultSnapshotByYear extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save VaultSnapshotByYear entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type VaultSnapshotByYear must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`,
      );
      store.set("VaultSnapshotByYear", id.toString(), this);
    }
  }

  static loadInBlock(id: string): VaultSnapshotByYear | null {
    return changetype<VaultSnapshotByYear | null>(
      store.get_in_block("VaultSnapshotByYear", id),
    );
  }

  static load(id: string): VaultSnapshotByYear | null {
    return changetype<VaultSnapshotByYear | null>(
      store.get("VaultSnapshotByYear", id),
    );
  }
...
export class RewardsDistributor extends Entity {
  ...
  static loadInBlock(id: string): RewardsDistributor | null {
    return changetype<RewardsDistributor | null>(
      store.get_in_block("RewardsDistributor", id),
    );
  }

  static load(id: string): RewardsDistributor | null {
    return changetype<RewardsDistributor | null>(
      store.get("RewardsDistributor", id),
    );
  }
...
export class RewardsDistribution extends Entity {
  ...
  static loadInBlock(id: string): RewardsDistribution | null {
    return changetype<RewardsDistribution | null>(
      store.get_in_block("RewardsDistribution", id),
    );
  }

  static load(id: string): RewardsDistribution | null {
    return changetype<RewardsDistribution | null>(
      store.get("RewardsDistribution", id),
    );
  }
...
export class AccountRewardsDistributor extends Entity {
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save AccountRewardsDistributor entity without an ID",
    );
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
  ...
  static load(id: string): AccountRewardsDistributor | null {
    return changetype<AccountRewardsDistributor | null>(
      store.get("AccountRewardsDistributor", id),
    );
  }
...
export class VaultLiquidation extends Entity {
  ...
  static loadInBlock(id: string): VaultLiquidation | null {
    return changetype<VaultLiquidation | null>(
      store.get_in_block("VaultLiquidation", id),
    );
  }

  static load(id: string): VaultLiquidation | null {
    return changetype<VaultLiquidation | null>(
      store.get("VaultLiquidation", id),
    );
  }
