...
export class VaultSnapshotByMonth extends Entity {
  ...
  static loadInBlock(id: string): VaultSnapshotByMonth | null {
    return changetype<VaultSnapshotByMonth | null>(store.get_in_block('VaultSnapshotByMonth', id));
  }

  static load(id: string): VaultSnapshotByMonth | null {
    return changetype<VaultSnapshotByMonth | null>(store.get('VaultSnapshotByMonth', id));
  }
...
export class VaultSnapshotByYear extends Entity {
  ...
  static loadInBlock(id: string): VaultSnapshotByYear | null {
    return changetype<VaultSnapshotByYear | null>(store.get_in_block('VaultSnapshotByYear', id));
  }

  static load(id: string): VaultSnapshotByYear | null {
    return changetype<VaultSnapshotByYear | null>(store.get('VaultSnapshotByYear', id));
  }
