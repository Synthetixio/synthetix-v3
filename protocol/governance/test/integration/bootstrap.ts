...
before(`setup integration chains`, async function () {
  ...
  const mothership = await spinChain<Proxies['mothership']>({
    ...
    cannonfileSettings: {
      ...
      wormhole_relayer: '0x6fcE2b4541508e3df7f60f03AE258dB124a9F111',
    },
    typechainFolder,
    writeDeployments,
  ...
  const [satellite1, satellite2] = await Promise.all([
    spinChain<Proxies['satellite1']>({
      ...
      cannonfileSettings: {
        ...
        wormhole_relayer: '0x3994Bc8B5bA1E8734616Cf00Fc2445F737242b8f',
      },
      typechainFolder,
      writeDeployments,
    ...
    spinChain<Proxies['satellite2']>({
      ...
      cannonfileSettings: {
        ...
        wormhole_relayer: '0x67916A923084F6e0Fe009e8ca0Ec56D395497Df3',
      },
      typechainFolder,
      writeDeployments,
