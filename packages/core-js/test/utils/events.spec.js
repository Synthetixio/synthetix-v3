...
const normalTxReceipt = {
  ...
  "logsBloom": "",
...
const deploymentTxReceipt = {
    ...
    "logsBloom": "",
...
describe('utils/events.js', () => {
  ...
  it('throws if the receipt logs are not parsed and no contract is specified for manual parsing', async () => {
    assert.throws(
      () => findEvent({ receipt: deploymentTxReceipt, eventName: 'Test' }),
      {
        message: 'Cannot find event Test in logs, and no contract interface was provided for manual parsing.'
      }
    );
  });
