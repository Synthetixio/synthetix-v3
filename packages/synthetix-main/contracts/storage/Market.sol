...
library Market {
    ...
    function getCapacityContribution(
        ...
        uint deltaValuePerShare = uint(maxDebtShareValue - self.poolsDebtDistribution.valuePerShare_d27.reducePrecision());
    ...
    function getDebtPerShare(Data storage self) internal view returns (int debtPerShare) {
        return self.poolsDebtDistribution.valuePerShare_d27.reducePrecision();
    }
    ...
    function adjustPoolShares(
        ...
        int128 lowPrecisionValuePerShare = self.poolsDebtDistribution.valuePerShare_d27.reducePrecisionInt128();
    ...
    function bumpPoolsOut(
        ...
        for (iters = 0; iters < maxIter; iters++) {
            ...
            int targetValuePerShare = self.poolsDebtDistribution.valuePerShare_d27.reducePrecision() +
            ...
            int debtToLimit = self.poolsDebtDistribution.totalShares.uint128toInt256().mulDecimal(
                poolMaxValuePerShare - self.poolsDebtDistribution.valuePerShare_d27.reducePrecision() // Diff between current value and max value per share.
            );
