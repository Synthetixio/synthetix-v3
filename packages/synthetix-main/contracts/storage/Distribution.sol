...
/**
 * @title Tracks value in USD, distributed amongst a set of actors using shares.
 *
 * A share represents a unit in which the total value is distributed, and these units have a USD value. The total USD value is `totalShares * valuePerShare`.
 *
 ...
 *   - actor1: 10 (100 USD)
 *   - actor2: 5 (50 USD)
 *   - actor3-actor10: 1 (10 USD)
 * - totalShares: 25 (250 USD)
 * - valuePerShare: 10 USD
 * - totalValue: 250 USD
 */
library Distribution {
    ...
    /**
     * @dev Adds or removes USD value to the distribution. The value is
     * distributed into each individual share by altering the distribution's `valuePerShare`.
     *
     * TODO: Consider renaming to distributeValue().
     */
     ...
     *
     * Returns the amount by which the distribution's total value changed.
     *
     ...
     * returns the total change in value for the actor given the change in valuePerShare.
     */
     ...
     * modifies the distribution's totalValue.
     *
    ...
    function updateActorValue(
        ...
        // is determined by the valuePerShare.
            ...
            // TODO: Why not use value / valuePerShare?
