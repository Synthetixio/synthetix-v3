...
contract IssueUSDModule is IIssueUSDModule {
    ...
    function mintUsd(
        ...
        epoch.consolidatedDebtDist.setActorValue(bytes32(uint(accountId)), newDebt);
    ...
    function burnUsd(
        ...
        epoch.consolidatedDebtDist.setActorValue(bytes32(uint(accountId)), debt - int(amount));
        pool.recalculateVaultCollateral(collateralType);
