...
library SharesLibrary {
    ...
    function distribute(Distribution storage dist, int amount) internal {
        ...
        dist.valuePerShare = int128(dist.valuePerShare) + int128((amount * 1e18) / int(totalShares));
    }
     ...
     */
    function updateDistributionEntry(DistributionEntry storage entry, uint totalShares) internal returns (int128) {
