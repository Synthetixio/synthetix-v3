...
library SharesLibrary {
     ...
     */
    function distribute(Distribution storage dist, int amount) internal {
        if (amount == 0) {
            return;
        }
     ...
     */
    function updateEntry(DistributionEntry storage entry, uint totalSharesAmount) internal returns (int128) {
     ...
     */
    function accumulateActor(Distribution storage dist, bytes32 actorId) internal returns (int changedValue) {
     ...
     */
    function getActorShares(Distribution storage dist, bytes32 actorId) internal view returns (uint shares) {
     ...
     */
    function getActorValue(Distribution storage dist, bytes32 actorId) internal view returns (int value) {
     ...
     */
    function totalValue(Distribution storage dist) internal view returns (int value) {
    ...
    // contribution amount
    function sharesForValue(Distribution storage dist, int value) internal view returns (uint shares) {
