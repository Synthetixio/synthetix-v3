...
interface IPoolModule {
    ...
    event PoolConfigurationSet(uint128 indexed poolId, PoolConfiguration.Data[] markets, address indexed sender);
    ...
    function setPoolConfiguration(uint128 poolId, PoolConfiguration.Data[] memory marketDistribution) external;

    /// @notice gets the pool positions
    function getPoolConfiguration(uint128 poolId) external view returns (PoolConfiguration.Data[] memory markets);
