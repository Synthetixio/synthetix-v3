...
import "./ElectionSchedule.sol";
import "./ElectionCredentials.sol";
import "./ElectionVotes.sol";
import "./ElectionTally.sol";

/// @title Module for electing a council, represented by a set of NFT holders
/// @dev This contract contains all election related external functions. Inherited code only provides encapsulated internal logic.
/// @dev This contract is abstract because you need to specify:
///        * ElectionTally._evaluateBallot(...)
///        * ElectionVotes._getVotePower(...)
abstract contract ElectionModule is
    IElectionModule,
    ElectionSchedule,
    ElectionCredentials,
    ElectionVotes,
