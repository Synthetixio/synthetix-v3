...
export interface Core_routerProxyInterface extends utils.Interface {
  functions: {
...
export interface Core_routerProxy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Core_routerProxyInterface;
