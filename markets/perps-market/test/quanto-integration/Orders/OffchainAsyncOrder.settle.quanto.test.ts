...
import { DEFAULT_SETTLEMENT_STRATEGY, bn, bootstrapMarkets } from '../../integration/bootstrap';
import { fastForwardTo } from '@synthetixio/core-utils/utils/hardhat/rpc';
import { snapshotCheckpoint } from '@synthetixio/core-utils/utils/mocha/snapshot';
import { SynthMarkets } from '@synthetixio/spot-market/test/common';
import { DepositCollateralData, depositCollateral } from '../../integration/helpers';
import assertBn from '@synthetixio/core-utils/utils/assertions/assert-bignumber';
import assertEvent from '@synthetixio/core-utils/utils/assertions/assert-event';
import assertRevert from '@synthetixio/core-utils/utils/assertions/assert-revert';
import { getTxTime } from '@synthetixio/core-utils/src/utils/hardhat/rpc';
import { calculateFillPrice, calculatePricePnl } from '../../integration/helpers/fillPrice';
import { wei } from '@synthetixio/wei';
import { calcCurrentFundingVelocity } from '../../integration/helpers/funding-calcs';
import { deepEqual } from 'assert/strict';

describe('Quanto Settle Offchain Async Order test', () => {
    ...
    perpsMarkets: [
      {
        ...
        token: 'snxETH',
        price: bn(1000),
        fundingParams: { skewScale: bn(100_000).div(10_000), maxFundingVelocity: bn(10) },
        quanto: {
          name: 'Bitcoin',
          token: 'snxBTC',
          price: bn(10_000),
      ...
      describe('settle order', () => {
        ...
        describe('settle order', () => {
          ...
          it('emits settle event', async () => {
            const accountId = 2;
            const skewScale = wei(100_000).div(10_000)
            const sizeDelta = bn(1).div(10_000);
            const fillPrice = calculateFillPrice(wei(0), skewScale, sizeDelta, wei(1000)).toBN();
            const newPositionSize = bn(1).div(10_000);
          ...
          it('emits market updated event', async () => {
            const price = bn(1000);
            const marketSize = bn(1).div(10_000);
            const marketSkew = bn(1).div(10_000);
            const sizeDelta = bn(1).div(10_000);
          ...
          it('check position is live', async () => {
            ...
            assertBn.equal(size, bn(1).div(10_000));
          });
