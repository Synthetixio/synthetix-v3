...
// @custom:artifact contracts/storage/PythERC7412Wrapper.sol:PythERC7412Wrapper
library PythERC7412Wrapper {
    bytes32 private constant _SLOT_ERC7412_WRAPPER = keccak256(abi.encode("io.synthetix.PythERC7412Wrapper"));
    struct Data {
        address pythAddress;
