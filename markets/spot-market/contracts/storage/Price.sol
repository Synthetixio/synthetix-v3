...
library Price {
     ...
     */
    function scale(int256 amount, uint decimals) internal pure returns (int256 scaledAmount) {
     ...
     */
    function scaleTo(int256 amount, uint decimals) internal pure returns (int256 scaledAmount) {
