...
contract TrustedMulticallForwarderTest is Test {
  ...
  function testAggregation() public {
    ...
    calls[0] = TrustedMulticallForwarder.Call(address(callee), abi.encodeWithSignature("getBlockHash(uint256)", block.number));
  ...
  function testUnsuccessfulAggregation() public {
    ...
    calls[0] = TrustedMulticallForwarder.Call(address(callee), abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls[1] = TrustedMulticallForwarder.Call(address(callee), abi.encodeWithSignature("thisMethodReverts()"));
    vm.expectRevert(bytes("TrustedMulticallForwarder: call failed"));
  ...
  function testTryBlockAndAggregate() public {
    ...
    calls[0] = TrustedMulticallForwarder.Call(address(callee), abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls[1] = TrustedMulticallForwarder.Call(address(callee), abi.encodeWithSignature("thisMethodReverts()"));
    (uint256 blockNumber, bytes32 blockHash, TrustedMulticallForwarder.Result[] memory returnData) = multicall.tryBlockAndAggregate(false, calls);
    assertEq(blockNumber, block.number);
  ...
  function testAggregate3() public {
    ...
    calls[0] = TrustedMulticallForwarder.Call3(address(callee), false, abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls[1] = TrustedMulticallForwarder.Call3(address(callee), true, abi.encodeWithSignature("thisMethodReverts()"));
    calls[2] = TrustedMulticallForwarder.Call3(address(multicall), true, abi.encodeWithSignature("getCurrentBlockTimestamp()"));
  ...
  function testAggregate3Unsuccessful() public {
    ...
    calls[0] = TrustedMulticallForwarder.Call3(address(callee), false, abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls[1] = TrustedMulticallForwarder.Call3(address(callee), false, abi.encodeWithSignature("thisMethodReverts()"));
    vm.expectRevert(bytes("TrustedMulticallForwarder: call failed"));
  ...
  function testAggregate3Value() public {
    TrustedMulticallForwarder.Call3Value[] memory calls = new TrustedMulticallForwarder.Call3Value[](3);
    calls[0] = TrustedMulticallForwarder.Call3Value(address(callee), false, 0, abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls[1] = TrustedMulticallForwarder.Call3Value(address(callee), true, 0, abi.encodeWithSignature("thisMethodReverts()"));
    calls[2] = TrustedMulticallForwarder.Call3Value(address(callee), true, 1, abi.encodeWithSignature("sendBackValue(address)", address(etherSink)));
    (TrustedMulticallForwarder.Result[] memory returnData) = multicall.aggregate3Value{value: 1}(calls);
    assertTrue(returnData[0].success);
    assertEq(keccak256(returnData[0].returnData), keccak256(abi.encodePacked(blockhash(block.number))));
    assertTrue(!returnData[1].success);
    assertTrue(returnData[2].success);
  ...
  function testAggregate3ValueUnsuccessful() public {
    TrustedMulticallForwarder.Call3Value[] memory calls = new TrustedMulticallForwarder.Call3Value[](3);
    calls[0] = TrustedMulticallForwarder.Call3Value(address(callee), false, 0, abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls[1] = TrustedMulticallForwarder.Call3Value(address(callee), false, 0, abi.encodeWithSignature("thisMethodReverts()"));
    calls[2] = TrustedMulticallForwarder.Call3Value(address(callee), false, 1, abi.encodeWithSignature("sendBackValue(address)", address(etherSink)));
    vm.expectRevert(bytes("TrustedMulticallForwarder: call failed"));
    multicall.aggregate3Value(calls);

    // Should fail if we don't provide enough value
    TrustedMulticallForwarder.Call3Value[] memory calls2 = new TrustedMulticallForwarder.Call3Value[](3);
    calls2[0] = TrustedMulticallForwarder.Call3Value(address(callee), true, 0, abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls2[1] = TrustedMulticallForwarder.Call3Value(address(callee), true, 0, abi.encodeWithSignature("thisMethodReverts()"));
    calls2[2] = TrustedMulticallForwarder.Call3Value(address(callee), true, 1, abi.encodeWithSignature("sendBackValue(address)", address(etherSink)));
    vm.expectRevert(bytes("TrustedMulticallForwarder: value mismatch"));
    multicall.aggregate3Value(calls2);

    // Works if we provide enough value
    TrustedMulticallForwarder.Call3Value[] memory calls3 = new TrustedMulticallForwarder.Call3Value[](3);
    calls3[0] = TrustedMulticallForwarder.Call3Value(address(callee), false, 0, abi.encodeWithSignature("getBlockHash(uint256)", block.number));
    calls3[1] = TrustedMulticallForwarder.Call3Value(address(callee), true, 0, abi.encodeWithSignature("thisMethodReverts()"));
    calls3[2] = TrustedMulticallForwarder.Call3Value(address(callee), false, 1, abi.encodeWithSignature("sendBackValue(address)", address(etherSink)));
