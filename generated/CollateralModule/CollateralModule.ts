...
export class CollateralModule__getCollateralConfigurationResultValue0Struct extends ethereum.Tuple {
  get depositingEnabled(): boolean {
    return this[0].toBoolean();
  }
...
export class CollateralModule__getCollateralConfigurationsResultValue0Struct extends ethereum.Tuple {
  get depositingEnabled(): boolean {
    return this[0].toBoolean();
  }
...
export class CollateralModule extends ethereum.SmartContract {
  ...
  getCollateralConfiguration(
    ...
    return changetype<CollateralModule__getCollateralConfigurationResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getCollateralConfiguration(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<CollateralModule__getCollateralConfigurationResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  getCollateralConfigurations(
    ...
    return result[0].toTupleArray<CollateralModule__getCollateralConfigurationsResultValue0Struct>();
  }
  ...
  try_getCollateralConfigurations(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<CollateralModule__getCollateralConfigurationsResultValue0Struct>()
    );
  }
